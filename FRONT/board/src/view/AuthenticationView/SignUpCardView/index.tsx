...
function FirstPage() {
    ...
    const onEmailValidateButtonHanlder = () => {
        if (!setEmailPatternCheck) return;
        ...
        <Box>
            ...
            <FormControl sx={{ mt: "40px" }} error={signUpError} fullWidth variant="standard">
                ...
                { 
                    ...
                    (<FormHelperText sx={{ color: 'red' }}>{'영문자 + 숫자 + 특수문자(!?_)를 포함한 8-20자를 입력해주세요.'}</FormHelperText>) :
                    (<></>)
                }
            </FormControl>
            <FormControl sx={{ mt: "40px" }} error={signUpError} fullWidth variant="standard">
        ...
        <Box>
            ...
            <FormControl sx={{ mt: '40px' }} error={signUpError} fullWidth variant="standard">
                ...
                />
                {
                    ...
                    telNumberValidate ? (<FormHelperText sx={{ color: 'green' }}>사용가능한 휴대전화번호입니다.</FormHelperText>) :
                                    (<FormHelperText sx={{ color: 'red' }}>사용 중인 휴대전화번호입니다.</FormHelperText>)
                }
            </FormControl>
            <FormControl sx={{ mt: '40px' }} error={signUpError} fullWidth variant="standard">
