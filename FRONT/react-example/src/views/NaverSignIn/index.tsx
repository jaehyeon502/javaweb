...
function NaverSignIn() {
    ...
    return (
        /* https://nid.naver.com/user2/V2Join?token_sjoin=qKDMbEHY4r6WdHU2&langSelect=ko_KR&chk_all=on&termsService=on&termsPrivacy=on&termsLocation=Y&termsEmail=Y */
        /* 레이아웃 구성 */
        ...
        <div>
            ...
            <div>
                ...
                <div id="logo-container">
                    <a id="logo" href="https://www.naver.com">
                        NAVER
                    </a>
                </div>
                {/* 컨테이너 레이아웃 */}
