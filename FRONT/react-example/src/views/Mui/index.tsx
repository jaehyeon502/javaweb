import { Button, IconButton, TextField, Box, Grid } from '@mui/material'
...
//? 디자인적으로 아름답고 다양한 사용자의 정의 옵션을 제공

//? npm install @mui/materal @emotion/react @emtion/styled
...
export default function Mui() {
    ...
    return (
        ...
        */}
        ...
        //^ 2. fullwidth
        //? Button Component를 Block 형태로 지정 (가로 사이즈를 100%)
        */}
        ...
        */}
            <Button disabled={true} variant="contained">Disabled true Button</Button>
            <Button disabled={false} variant="contained">Disabled false Button</Button>

            <Button disabled={buttonDisabled} variant="contained" fullWidth>Disabled Button</Button>
