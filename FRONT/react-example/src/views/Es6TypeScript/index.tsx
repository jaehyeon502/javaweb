...
export default function Es6TypeScript() {
    ...
    //# 6. for
    //? foreach 반복문 
    //? Java -> for (요소의 데이터타입 변수명: 반복해서접근할배열) {}
    ...
    //? Spread 연산자
    //? ...객체
    //? 비구조화 할당에 쓰일 떄는 직접 뽑은 요소를 제외한 나머지 요소를 하나의 묶음으로 묶어줌
