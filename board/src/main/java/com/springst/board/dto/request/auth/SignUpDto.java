package com.springst.board.dto.request.auth;
...
public class SignUpDto {
    ...
    @ApiModelProperty(value="사용자 비밀번호", example="qwerqwerqwer", required=true)
    @NotBlank
    @Length(min=8, max=20)
    ...
    @ApiModelProperty(value="사용자 전화번호", example="010-1111-1111", required=true)
    @NotBlank
