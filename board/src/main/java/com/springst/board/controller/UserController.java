...
public class UserController {
    ...
    private final String VALIDATE_TELNUMBER = "/validate/telNumber";
    ...
    @ApiOperation(value="유저 휴대 전화번호 중복체크", notes="Request Body에 telNumber을 포함하여 요청하면, 중복 결과를 반환, 실패시 실패 메세지를 반환")
